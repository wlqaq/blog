        ...
        <form class="layui-form" >
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    ...
                    <input type="checkbox" name="status" value="<?php echo e($roles->id); ?>" title="<?php echo e($roles->name); ?>" <?php if(in_array($roles->id,$user_role)): ?> checked <?php endif; ?>>
...
<?php /**PATH G:\repository\blog\resources\views/admin/role/auth.blade.php ENDPATH**/ ?>