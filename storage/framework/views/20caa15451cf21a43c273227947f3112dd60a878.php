...
<script src="<?php echo e(asset('/home/js/vue.min.js')); ?>"></script>
              ...
              submit() {
                  ...
                  if(this.islogin == ""){
                   ...
                   axios.post('/message',{
                       msg:_this.msg,
                       _token:'<?php echo e(csrf_token()); ?>',
                       email:'<?php echo e(session()->get('homeuser')); ?>'
...
<?php /**PATH D:\blog\resources\views/home/message.blade.php ENDPATH**/ ?>