                            ...
                            <table class="layui-table layui-form">
                              ...
                              <?php $__currentLoopData = $role; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                  ...
                                  <td class="td-manage">
                                      <a title="授权"  onclick="xadmin.open('角色授权','<?php echo e(url('/admin/role/auth/'.$v->id)); ?>')" href="javascript:;">
    ...
    <script>
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
              //发异步删除数据
              $.post('/admin/role/'+id,{"_method":'delete',"_token":"<?php echo e(csrf_token()); ?>"},function(data){
                  if(data.status == 0){
...
<?php /**PATH H:\laravel\blog\resources\views/admin/role/index.blade.php ENDPATH**/ ?>